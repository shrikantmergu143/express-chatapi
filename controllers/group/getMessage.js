...
const getMessages = async (req, res) => {
    try {
        const group_id = req.params.group_id; // Assuming the friend_id is passed as a parameter
        ...
        const totalMessageCount = await Message.countDocuments({ group_id: group_id });
